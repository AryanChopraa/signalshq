        ...
        <div className="flex flex-col lg:flex-row items-center gap-12">
          <div className="lg:w-1/2">
            ...
            >
              ...
              <img 
                src="public/uploads/feature3.avif" 
          ...
          <motion.div 
            ...
            className="lg:w-1/2"
          >
            <div className="section-title">Client Satisfaction</div>
            <h2 className="text-3xl md:text-4xl font-display font-bold mb-6">Drive collaboration with clients</h2>
            <p className="text-lg text-gray-700 mb-8">
              Centralise your document management, and ensure clear communication with clients. Ensure proper control and trail for all PBC data.
            </p>
            <motion.ul 
              initial="hidden"
              whileInView="visible"
            ...
            >
              {[
                "Simplified document requests and tracking",
                "Real-time status updates and notifications",
                "Secure client portal for easy file sharing",
                "Automated reminders to improve response times"
              ].map((point, index) => (
                <motion.li 
                  key={index} 
                  variants={{
